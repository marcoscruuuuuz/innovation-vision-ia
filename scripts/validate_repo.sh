...
required_files=(README.md docker-compose.yml .env.example architecture/schema.sql configs/event_catalog.yaml configs/p2p.example.yaml scripts/install_ubuntu.sh docs/01-ARCHITECTURE.md docs/02-DASHBOARD.md docs/03-EVENTS.md docs/04-P2P-WINE.md docs/05-CERTIFICATION.md docs/06-AI-IDE.md docs/07-DATA-SECURITY.md docs/08-INSTALLATION.md docs/09-IMPLEMENTATION-PHASES.md docs/10-ACCEPTANCE.md docs/11-REACTIVE-INGESTION.md docs/12-CORE-PLATFORM.md architecture/migrations/010_operational_portals.sql architecture/migrations/011_rule_engine_defaults.sql architecture/migrations/012_evidence_clip_jobs.sql architecture/migrations/013_temporal_candidate_idempotency.sql architecture/migrations/014_after_22h_guard.sql architecture/migrations/015_event_catalog_canonical_defaults.sql architecture/migrations/016_client_condominiums_rls.sql)
